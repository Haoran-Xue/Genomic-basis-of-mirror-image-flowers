...
/mnt/barn/hxue/programs/gffread/gffread \
-w Wp002WmWpST.fa \
-g /mnt/barn/hxue/2022-11-24-Wpaniculata-pacbio/1.genome_assembly/Wp002.hifi.bp.p_ctg.fa \
-E Wp002.WmWp.ST.gtf

nohup /mnt/barn/hxue/programs/salmon-1.9.0_linux_x86_64/bin/salmon index -t Wp002WmWpST.fa -i Wp002WmWpST &
...
nohup nice -n 10 /mnt/barn/hxue/programs/salmon-1.9.0_linux_x86_64/bin/salmon quant --gcBias -i /mnt/barn/hxue/Wachendorfia_RNA-Seq_analyses/Wp002WmWpST -l IU \
	-1 $f1 \
	-2 $f2 \
...
/mnt/barn/hxue/programs/gffread/gffread -w BaN.ST.fa -g /mnt/barn/hxue/Ba_Ngeli_ONT/1.genome_assembly/Ba_Ngeli_ONT.bp.p_ctg.fa -E BaN.ST.gtf

nohup /mnt/barn/hxue/programs/salmon-1.9.0_linux_x86_64/bin/salmon index -t BaN.ST.fa -i BaN.ST &
